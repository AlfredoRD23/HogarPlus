...
export function ReferClientForm({
  ...
  return (
    ...
    >
      ...
      <Field label="Nombre del referido" hint={fieldHint("name")} error={errors.firstName}>
        <FormattedInput kind="name" required value={firstName} error={Boolean(errors.firstName)} onValue={setFirstName} />
      </Field>
      <Field label="Apellido del referido" hint={fieldHint("name")} error={errors.lastName}>
        <FormattedInput kind="name" required value={lastName} error={Boolean(errors.lastName)} onValue={setLastName} />
      </Field>
      <Field label="Teléfono del referido" hint={fieldHint("phone")} error={errors.phone}>
